export const serviceCards = [
  {
    ...
    cardimageClass:"w-56 h-50 sm:w-82 sm:h-66 md:w-50 md:h-40 lg:w-80 md:h-66 absolute right-[-34px] top-[34px] sm:top-[40px] md:top-[80px] ",
  },
  {
    id: 2,
    title: "INSTANMART",
    subtitle: "THE EVERYTHINGS STORE",
    offer: "FREE DELIVERY",
    image:
      "https://static.vecteezy.com/system/resources/thumbnails/054/591/691/small/3d-render-of-cosmetics-products-free-png.png",
    cardClass: "h-[220px] sm:h-[230px] md:h-[236px] lg:h-[270px]",
    cardimageClass:"w-44 h-42 md:w-47 md:h-24 lg:w-72 md:h-58 absolute right-[-25px] top-[76px] sm:top-[80px] md:top-[80px] ",
  ...
  },
  {
    ...
    offer: "UP TO 50% OFF",
    image:
      "https://static.vecteezy.com/system/resources/thumbnails/053/204/993/small/cutlery-on-plates-with-beige-napkin-on-transparent-background-free-png.png",
    cardClass: "h-[220px] sm:h-[230px] md:h-[236px] lg:h-[270px]",
    cardimageClass:"w-44 h-36 md:w-40 md:h-28 lg:w-58 md:h-44 absolute right-[-28px] top-[100px] md:top-[100px] lg:top-[120px]",
